...
plot(table$Voltage~table$dateTime, type="l", ylab="Voltage (volt)", xlab="")
...
plot(table$Global_reactive_power~table$dateTime, type="l", ylab="Global Rective Power (kilowatts)",xlab="")
